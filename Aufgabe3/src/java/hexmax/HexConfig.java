...
public record HexConfig(int maxMoves, Symbol[] digits, Alphabet alphabet) {
	...
	public static HexConfig readFrom(InputStream exerciseIn, InputStream alphabetIn)
			throws IOException {
		try (var reader = new BufferedReader(new InputStreamReader(exerciseIn,
			...
			// Es können nie mehr Stellen bewegt werden, als es zur Verfügung stehen, aber es
			// können auch nie mehr Stellen bewegt werden, als freie Plätze zur Verfügung stehen
